...
{{--                                    </div>--}}
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <label>
                                                <input type="radio" name="role" class="flat" value="admin" {{$item->role == 'admin' ? 'checked' : ''}}> Admin
                                            </label>
                                            <label>
                                                <input type="radio" name="role" class="flat" value="leader" {{$item->role == 'leader' ? 'checked' : ''}}> Leader
                                            </label>
                                            <label>
                                                <input type="radio" name="role" class="flat" value="member" {{$item->role == 'member' ? 'checked' : ''}}> Member
                                            </label>
                                        </div>
                                    </div>
                                    <div class="item form-group">
