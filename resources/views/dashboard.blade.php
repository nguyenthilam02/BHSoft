...
{{--                        <span class="count_bottom"><i class="green">4% </i> From last Week</span>--}}
                    ...
                    <div class="col-md-3 col-sm-5  tile_stats_count">
                        <span class="count_top"><i class="fa fa-clock-o"></i> Tổng số dự án</span>
                        <div class="count">{{ $projects->count() }}</div>
{{--                        <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>--}}
                    </div>
                    <div class="col-md-3 col-sm-5  tile_stats_count">
                        <span class="count_top"><i class="fa fa-user"></i> Tổng số issue</span>
                        <div class="count green">{{ $issues->count() }}</div>
