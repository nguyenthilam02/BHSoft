                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <ul class="nav navbar-right panel_toolbox">
                                    ...
                                    {{--                                        </ul>--}}
                                    {{--                                    </li>--}}
                                    <li><a href="{{route('document.index')}}" class="close-link"><i class="fa fa-close"></i></a>
                                    </li>
                                </ul>
                            ...
                            <div class="x_content">
                                <br/>
                                <form id="demo-form2" action="{{route('document.store')}}" method="POST"  enctype="multipart/form-data"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <textarea class="resizable_textarea form-control" name="description"
                                                      placeholder="Nhập mô tả tài liệu của bạn tại đây...">{{old('description')}}</textarea>
                                        </div>
                                    </div>
